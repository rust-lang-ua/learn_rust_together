...
- :question: [Get answer](https://github.com/ChapliaS/LearnRustTogether/blob/master/about_us.md#question-faq) : our FAQ and community rules.
...
- :globe_with_meridians: [Still not enough](https://github.com/rust-lang-ua/learn_rust_together/blob/master/collection_of_collections.md#globe_with_meridians-other-collections-on-rust) : other collections on Rust
