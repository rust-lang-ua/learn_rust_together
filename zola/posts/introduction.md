...
:zap: Other interesting sources you can find in our [ Awesome Collection of Materials](/posts/learn#mortar_board-our-awesome-collection-of-materials-to-learn-rust).

## [:gear: How to set up rust](/posts/rust-setup)
...
:zap:	There is also our [Communicate](/posts/communicate) page, where you can find a lot of different Rust global or local chats and news streams.
...
:zap:	Other interesting books you can find in our [Awesome Collection of Materials](/posts/learn#mortar_board-our-awesome-collection-of-materials-to-learn-rust).
...
:zap: More video courses you cand find on our [awesome collection to learn Rust](https://github.com/rust-lang-ulearn_rust_together/blob/master/learn.md#star-general-purpose-courses)
