...
- [miette](https://github.com/zkamiette) by [Kat Marchán](https://github.com/zkat) : error reporting facilities
...
- [flex-error](https://github.com/informalsystemflex-error) by [Soares Chen](https://github.com/soareschen) : adapter for error handling approaches
...
- [litrs](https://github.com/LukasKalbertodlitrs) by [Lukas Kalbertodt](https://github.com/LukasKalbertodt) : parse Rust literals
...
- [maplit](https://github.com/blusmaplit) by [bluss](https://github.com/bluss) : literal macros for containers
...
- [field_names](https://github.com/TedDriggfield_names) by [Ted Driggs](https://github.com/TedDriggs) : derive to list names of fields bound to the structure
...
- [reinda](https://github.com/LukasKalbertodreinda) by [Lukas Kalbertodt](https://github.com/LukasKalbertodt) : embed s
- [vergen](https://github.com/rustyhordvergen) by [Jason Ozias](https://github.com/jasonozias) : ( _hardware_ ) ( _compile_time_ ) compile-time constants about process of compilation
...
- [imgui](https://github.com/imgui-rimgui-rs) by [Joonas Javanainen](https://github.com/Gekkio) : an immediate mode GUI
- [iced](https://github.com/iced-riced) by [Héctor Ramón](https://github.com/hecrj) : cross-platform GUI inspired by Elm
...
- [indicatif](https://github.com/console-rindicatif) by [Armin Ronacher](https://github.com/mitsuhiko) : command line progress reporting
...
- [cursive](https://github.com/gyscoCursive) by [Alexandre Bury](https://github.com/gyscos) : TUI framework
- [expectrl](https://github.com/zhiburexpectrl) by [Maxim Zhiburt](https://github.com/zhiburt) ( _testing_ ) ( _os_ ) : controlling input/output of interactive programs

## Command user interface parsing

( _ui_ ) ( _cui_ ) ( _cui_parsing_ )

- :earth_africa: [clap](https://github.com/clap-rclap) by [Kevin K.](https://github.com/kbknapp) : the most popular CUI parsing
...
- [termion](https://gitlab.redox-os.org/redox-otermion) by [Ticki](https://github.com/ticki) : low-level handling, manipulating and reading information about terminals
- [crossterm](https://github.com/crossterm-rcrossterm) by [Timon](https://github.com/TimonPost) : cross platform terminal
- [atty](https://github.com/softpropatty) by [Doug Tangren](https://github.com/softprops) : check is it a tty
- [termize](https://github.com/JohnTitor/termize) by [Yuki Okushi](https://github.com/JohnTitor) : terminal size
- [terminal_size](https://github.com/eminencterminal-size) by [Andrew Chin](https://github.com/eminence) : terminal size
...
- [bunt](https://github.com/LukasKalbertodbunt) by [Lukas Kalbertodt](https://github.com/LukasKalbertodt) :  colored and formatted text to a terminal
...
- [neon](https://github.com/neon-bindingneon) by [Dave Herman](https://github.com/dherman) : native Node.js modules
...
- [tauri](https://github.com/tauri-apptauri) by [Razvan Stoenescu](https://github.com/rstoenescu) : desktop applications with a web frontend
...
- [cargo-generate](https://github.com/cargo-generatcargo-generate) by [ashley williams](https://github.com/ashleygwilliams) : utility to instantiate a template ( _templating_ )
- [cargo-depgraph](https://crates.io/cratecargo-depgraph) by [Jonas Platte](https://blog.turbo.fish/) : generate dependencies graph
...
- [cross](https://github.com/rust-embedded/cross) by [Jorge Aparicio](https://github.com/japaric) ( _build_ ) ( _cross_compile_ ) ( _testing_ ) : cross-compilation and cross-testing
- [wasm-bindgen-test](https://github.com/rustwasm/wasm-bindgen/tremain/crates/test) by [Alex Crichton](https://github.com/alexcrichton) ( _wasm_ ) : run tests of wasm-based application in browser
...
- [expectrl](https://github.com/zhiburexpectrl) by [Maxim Zhiburt](https://github.com/zhiburt) ( _ui_ ) ( _tui_ ) ( _os_ ) : controlling input/output of interactive programs
...
- [test-case](https://github.com/frondeutest-case) by [Wojciech Polak](https://github.com/frondeus) : procedural macro attribute for adding test cases
- [cucumber](https://github.com/cucumber-rcucumber) by [Brendan Molloy](https://github.com/bbqsrc) : BBD
...
- [drill](https://github.com/fcsonlindrill) by [Ferran Basora](https://github.com/fcsonline) ( _network_ ) ( _perf_benchmark_ ) : HTTP load testing
...
- [loom](https://github.com/tokio-rloom) by [Carl Lerche](https://github.com/carllerche) : ( _perf_benchmark_ ) concurrency permutation testing
...
- [wasm-server-runner](https://github.com/jakobhellermann/wasm-server-runner/tremain) by [Jakob Hellermann](https://github.com/jakobhellermann) : run in the browser
- [wasm-bindgen-test](https://github.com/rustwasm/wasm-bindgen/tremain/crates/test) by [Alex Crichton](https://github.com/alexcrichton) ( _testing_ ) : run tests of wasm-based application in browser
...
- [wasm-tools](https://github.com/bytecodealliancwasm-tools) by [Yury Delendik](https://github.com/yurydelendik): tooling for WebAssembly
- [wasmtime](https://github.com/bytecodealliancwasmtime) by [Jakob Stoklund Olesen](https://github.com/stoklund) : standalone JIT-style runtime
...
- [wizer](https://github.com/bytecodealliancwizer) by [Nick Fitzgerald](https://github.com/fitzgen) : performance optimization by compile-time pre-initialization
...
- [kuchiki](https://github.com/kuchiki-rkuchiki) by [Simon Sapin](https://github.com/SimonSapin) : HTML/XML tree manipulation
...
- [stdweb](https://github.com/koutstdweb) by [Koute](https://github.com/koute) : standard library for the client-side Web
- [web-log](https://github.com/DoumanAsh/web-log) by [Douman](https://github.com/DoumanAsh) : minimal wrapper over browser console
- [web-sys](https://github.com/rustwasm/wasm-bindgen/tremain/crates/web-sys) by [Nick Fitzgerald](https://github.com/fitzgen) : Raw wasm-bindgen imports for all of the Web's APIsDescription
- [js-sys](https://github.com/rustwasm/wasm-bindgen/tremain/crates/js-sys) by [Alex Crichton](https://github.com/alexcrichton) ( _bindings_ ) : Raw bindings to JS global APIs for projects using wasm-bindgen
- [gloo](https://github.com/rustwasm/gloo) by [Nick Fitzgerald](https://github.com/fitzgen) : alternative of web-sys
- [wasm-bindgen-futures](https://github.com/rustwasm/wasm-bindgen/tremain/crates/futures) by [Alex Crichton](https://github.com/alexcrichton) ( _concurrency_ ) : bridges the gap between a Rust Future and a JavaScript Promise

## Web Frontend

( _web_frontend_ )

- [sycamore](https://github.com/sycamore-rsycamore) by [Luke Chu](https://github.com/lukechu10) : reactive frontend
...
- [seed](https://github.com/seed-rseed) by [David O'Connor](https://github.com/David-OConnor) : Elm-inspired frontend
...
- [axum](https://github.com/tokio-raxum) by [David Pedersen](https://github.com/davidpdrsn) : tokio-based web backend framework
...
- [penguin](https://github.com/LukasKalbertodpenguin) by [Lukas Kalbertodt](https://github.com/LukasKalbertodt) : a static server
...
- [netraffic](https://github.com/ZingerLittleBenetraffic) by [ZingerLittleBee](https://github.com/ZingerLittleBee) : statistics network traffic
- [portpicker](https://github.com/Dentosal/portpicker-rs) by [Hannes Karppila](https://github.com/Dentosal) ( _network_ ) ( _testing_ ) : pick a free unused port
- [drill](https://github.com/fcsonlindrill) by [Ferran Basora](https://github.com/fcsonline) ( _network_ ) ( _testing_ ) : HTTP load testing application

## Database

( _db_ )

- :earth_africa: [diesel](https://github.com/diesel-rdiesel) by [Sage Griffin](https://github.com/sgrif) : ORM and query builder
...
- :earth_africa: [sqlx](https://github.com/launchbadgsqlx) by [Ryan Leckey](https://github.com/mehcode) : SQL DBMS driver
- [ormx](https://github.com/NyxCodormx) by [NyxCode](https://github.com/NyxCode) : orm-like features to sqlx
- [dynomite](https://github.com/softpropdynomite) by [Doug Tangren](https://github.com/softprops) : DynamoDB binding
- [redis](https://github.com/mitsuhiko/redis-rs) by [Armin Ronacher](https://github.com/mitsuhiko) : Redis binding
- [datafusion](https://github.com/apacharrow-datafusion) by [Jacques Nadeau](https://github.com/jacques-n) ( _db_ ) ( _data_science_ ) : query engine from Apache
...
- [rusqlite](https://github.com/rusqlitrusqlite) by [hydhknn](https://github.com/hydhknn) : bindings to SQLite
...
- [polars](https://github.com/pola-rpolars) by [https://github.com/ritchie46](Ritchie Vink) : multi-threaded DataFrame library
- [datafusion](https://github.com/apacharrow-datafusion) by [Jacques Nadeau](https://github.com/jacques-n) ( _db_ ) ( _data_science_ ) : query engine from Apache
- [arrow](https://github.com/apacharrow-rs) by [Jacques Nadeau](https://github.com/jacques-n) : working with bytes from Apache

## Functional programming

( _functional_ )

- [itertools](https://github.com/rust-itertoolitertools) by [bluss](https://github.com/bluss) : extra iterator tools  ???
...
- [shiplift](https://github.com/softpropshiplift) by [Doug Tangren](https://github.com/softprops) : maneuvering docker containers
...
- [pin-project](https://github.com/taiki-pin-project) by [Taiki Endo](https://github.com/taiki-e) : synchronization primitives pin-projection
- [pin-project-lite](https://github.com/taiki-pin-project-lite) by [Taiki Endo](https://github.com/taiki-e) : synchronization primitives pin-projection, lite version
- [blocking](https://github.com/smol-rblocking) by Stjepan Glavina : a thread pool for isolating blocking I/O in async environment
- [async-compat](https://github.com/smol-rasync-compat) by [Taiki Endo](https://github.com/taiki-e) : compatibility adapter between tokio and futures
...
- [waker-fn](https://github.com/smol-rwaker-fn) by Stjepan Glavina : convert closures into waker

## Async Runtimes

( _async_ ) ( _async_runtime_ )

- [tokio](https://github.com/tokio-rtokio) by [Carl Lerche](https://github.com/carllerche) : asynchronous application framework
- [async-std](https://github.com/async-rasync-std) by [Florian Gilcher](https://github.com/skade) : async version of std
- [pollster](https://github.com/zesterer/pollster) by [Joshua Barretto](https://github.com/zesterer) : a minimal async executor
- [smol](https://github.com/smol-rsmol) by Stjepan Glavina : a small and fast async runtime for Rust

## Concurrency

( _concurrency_ )

- [radium](https://github.com/bitvecto-rradium) by [Nika Layzell ](https://github.com/mystor) : atomic instructions fallback
- [rayon](https://github.com/rayon-rrayon) by [Niko Matsakis](https://github.com/nikomatsakis) : data-parallelism
- [futures-signals](https://github.com/Pauan/rust-signals) by [Pauan](https://github.com/Pauan) : reactive signals
- [crossbeam](https://github.com/crossbeam-rcrossbeam) by [Aaron Turon](https://github.com/aturon) : tools for concurrent programming
...
- [atomig](https://github.com/LukasKalbertodatomig) by [Lukas Kalbertodt](https://github.com/LukasKalbertodt) : type constructor of atmotics
...
- [schedule](https://github.com/mehcodschedule-rs) by [Ryan Leckey](https://github.com/mehcode) : in-process cron-like scheduler
...
- [bytes](https://github.com/tokio-rbytes) by [Carl Lerche](https://github.com/carllerche) : working with bytes
- [arrow](https://github.com/apacharrow-rs) by [Jacques Nadeau](https://github.com/jacques-n) : working with bytes from Apache
...
- [byte-slice-cast](https://github.com/sdroegbyte-slice-cast) by [Sebastian Dröge](https://github.com/sdroege) : casting to / from byte slice
- [zerocopy](https://docs.rzerocopy/) by [Joshua Liebow-Feeser](https://github.com/joshlf) ( _serialization_ ) : zero-copy parsing and serialization
- [memmap](https://github.com/danburkermemmap-rs) by [Dan Burkert](https://github.com/danburkert) : API for memory mapped IO
- [wee_alloc](https://github.com/rustwasm/wee_alloc) by [Nick Fitzgerald](https://github.com/fitzgen) : 1kB-size memory allocator for size-optimized builds
...
- [zerocopy](https://docs.rzerocopy/) by [Joshua Liebow-Feeser](https://github.com/joshlf) ( _mem_ ) : zero-copy parsing and serialization
...
- :earth_africa: [serde](https://github.com/serde-rserde) by [David Tolnay](https://github.com/dtolnay) : the most popular serialization framework
...
- [speedy](https://github.com/koutspeedy) by [Koute](https://github.com/koute) : another serialization alternative
...
- [lexical-core](https://github.com/Alexhuszagh/rust-lexical/tremain/lexical-core) by [Alexander Huszagh](https://github.com/Alexhuszagh) ( _parser_ ) : minimal implementation of lexical
...
- [num-format](https://github.com/bcmyernum-format) by [Brian Myers](https://github.com/bcmyers) : formatting of numbers
- [tabled](https://github.com/zhiburtabled) by [Maxim Zhiburt](https://github.com/zhiburt) : textual tables formatting
...
- [combine](https://github.com/Marwecombine) by [Markus Westerlind](https://github.com/Marwes) : parser combinators
- [combine-language](https://github.com/Marwecombine-language) by [Markus Westerlind](https://github.com/Marwes) : extension of combine to generate parsers of programming languages
...
- [lrlex](https://github.com/softdevteam/grmtooltree/master/lrlex) by [Lukas Diekmann](https://github.com/ptersilie) : lex/flex inspired lexer
...
- [ress](https://github.com/rusty-ecmRESS) by [Robert Masen](https://github.com/FreeMasen) : tokenizer of JS
- [ressa](https://github.com/rusty-ecmRESSA) by [Robert Masen](https://github.com/FreeMasen) : parser of JS
- [syntect](https://github.com/trishumsyntect) by [Tristan Hume](https://github.com/trishume) : syntax highlighting using Sublime text syntax definitions
...
- :earth_africa: [time](https://github.com/time-rtime) by [Jacob Pratt](https://github.com/jhpratt) : the most popular date and time module
- [chrono](https://github.com/chronotopchrono) by [Kang Seonghoon](https://github.com/lifthrasiir) : date and time module, maintained poorly
...
- [fastrand](https://github.com/smol-rfastrand) by [Stjepan Glavina](https://github.com/smol-rs) : fast random number generator
- [uuid](https://github.com/uuid-ruuid) by [Biru Mohanathas](https://github.com/poiru) : generate and parse UUIDs
...
- [total_float_wrap](https://github.com/tritoktotal_float_wrap) by [](https://github.com/tritoke) : hash and equal for floats
...
- [either](https://github.com/bluseither) by [bluss](https://github.com/bluss) : enum Either with variants Left and Right is a general purpose sum type with two cases
- [ptr-union](https://github.com/CAD97/pointer-utiltree/master/crates/ptr-union) by [Christopher Durham](https://github.com/CAD97) : union of pointers storing the tag in alignment bits
- [erasable](https://github.com/CAD97/pointer-utiltree/master/crates/erasable) by [Christopher Durham](https://github.com/CAD97) : produce type-less pointers
- [rc-box](https://github.com/CAD97/pointer-utiltree/master/crates/rc-box) by [Christopher Durham](https://github.com/CAD97) : better Rc< Box > and Arc< Box >
- [rc-borrow](https://github.com/CAD97/pointer-utiltree/master/crates/rc-borrow) by [Christopher Durham](https://github.com/CAD97) : borrow Rc/Arc without wrapping borrowed
- [triomphe](https://github.com/Manishearth/triomphe) by [Manish Goregaokar](https://github.com/Manishearth) : FFI-focused ARC
- [scopeguard](https://github.com/blusscopeguard) by [bluss](https://github.com/bluss) : run a given closure when it goes out of scope
...
- [indexmap](https://github.com/blusindexmap) by [bluss](https://github.com/bluss) : hash table which preserves insertion order
...
- [bitvec](https://github.com/bitvecto-rbitvec) by [Alexander Payne](https://github.com/myrrlyn) : bitfields
- [bitflags](https://github.com/bitflagbitflags) by [Alex Crichton](https://github.com/bitflags) : macro to generate structures which behave like bitflags
- [growable-bloom-filter](https://github.com/dpbrigggrowable-bloom-filters) by [David Briggs](https://github.com/dpbriggs) : growable bloom filter
...
- [unicode-width](https://github.com/unicode-runicode-width) by [Riad S. Wahby](https://github.com/kwantam) : displayed width
- [unicode-segmentation](https://github.com/unicode-runicode-segmentation) by [Riad S. Wahby](https://github.com/kwantam) : iterate graphemes of unicode string
...
- [twoway](https://github.com/blustwoway) by [bluss](https://github.com/bluss) : twoway substring search
...
- [heck](https://github.com/withoutboatheck) by [Saoirse Shipwreckt](https://github.com/withoutboats) : case conversion
- [convert-case](https://github.com/rutrum/convert-case) by [Dave Purdum](https://github.com/rutrum) : case conversion
- [slice-dst](https://github.com/CAD97/pointer-utiltree/master/crates/slice-dst) by [Christopher Durham](https://github.com/CAD97) : slice-based DST allocation
...
- [arrayvec](https://github.com/blusarrayvec) by [bluss](https://github.com/bluss) : stack-based vector and string
...
- [ouroboros](https://github.com/joshua-maroouroboros) by [Joshua Maros](https://github.com/joshua-maros) : self-referential struct generation
...
- [slab](https://github.com/tokio-rslab) by [Carl Lerche](https://github.com/carllerche) : hashMap-like collection with implicit key
- [indexing](https://github.com/blusindexing) by [bluss](https://github.com/bluss) : solving indexing problem by associating lifetime with intervals
...
- [seahash](https://gitlab.redox-os.org/redox-oseahash) by [Tom Almeida](https://github.com/Tommoa) : one of the fastest non-cryptographic hashing algorithm
...
- [elgamal-curve25519](https://github.com/chritchenelgamal-curve25519) by [Christian Nyumbayire](https://github.com/chritchens) : ElGamal homomorphic encryption on Curve25519
- [argonautica](https://github.com/bcmyerargonautica) by [Brian Myers](https://github.com/bcmyers) : password hashing
- [rust-argon2](https://github.com/sru-systemrust-argon2) by [Martijn Rijkeboer](https://github.com/mrijkeboer) :  password hashing

## Compression

( _compression_ )

- [yazi](https://github.com/dfrg/yazi) by [Chad Brokaw](https://github.com/dfrg) : deflatzlib compression
...
- [percent-encoding](https://github.com/servo/rust-url/tremaster/percent_encoding) by [Simon Sapin](https://github.com/SimonSapin) : do [URL percent encoding](https://en.wikipedia.org/wiki/Percent-encoding)
...
- [imageproc](https://github.com/image-rimageproc) by [image-rs](https://github.com/image-rs) : library for images processing
...
- [fs2](https://github.com/danburkerfs2-rs) by [Dan Burkert](https://github.com/danburkert) : extra system fs routines
...
- [filetime](https://github.com/bitflagfiletime) by [Alex Crichton](https://github.com/bitflags) : file timestamps reading / writing
...
- [telefork](https://github.com/trishumtelefork) by [Tristan Hume](https://github.com/trishume) : remote fork()
- [expectrl](https://github.com/zhiburexpectrl) by [Maxim Zhiburt](https://github.com/zhiburt) ( _ui_ ) ( _tui_ ) ( _testing_ ) : controlling input/output of interactive programs
- [nix](https://github.com/nix-rusnix) by [Carl Lerche](https://github.com/carllerche) : nix APIs
...
- [hermit-sys](https://github.com/hermitcorrusty-hermit) by [Stefan Lankes](https://github.com/stlankes) : lightweight unikernel
...
- [tracing](https://github.com/tokio-rtracing) by [Eliza Weisman](https://github.com/hawkw) :
...
- [config](https://github.com/mehcodconfig-rs) by [Ryan Leckey](https://github.com/mehcode) : generic config manager
...
- [crossbow](https://github.com/dodorarcrossbow) by [David Ackerman](https://github.com/enfipy) : cross-platform rust toolkit for games
...
- [ndk-glue](https://github.com/rust-windowing/android-ndk-rtree/master/ndk-glue) by [David Craven](https://github.com/dvc94ch) : interoperability library for a native Rust application with the Android framework
- [ndk-sys](https://github.com/rust-windowing/android-ndk-rtree/master/ndk-sys) by [David Craven](https://github.com/dvc94ch) ( _bindings_ ) : raw FFI bindings to the NDK
...
- [cargo-apk](https://github.com/rust-windowing/android-ndk-rtree/master/cargo-apk) by [David Craven](https://github.com/dvc94ch) ( _build_ ) : tool for creating Android packages
...
- [cargo-generate](https://github.com/cargo-generatcargo-generate) by [ashley williams](https://github.com/ashleygwilliams) : utility to instantiate a template ( _cargo_ ) ( _build_ )
...
- [cargo-audit](https://github.com/RustSec/rustsec/tremain/cargo-audit) by [Tony Arcieri](https://github.com/tarcieri) : Audit Cargo.lock files for crates with security vulnerabilities reported to the RustSec Advisory Database
- [cargo-udeps](https://github.com/est31/cargo-udeps) by [est31](https://github.com/est31) : Find unused dependencies in Cargo.toml
- [cargo-watch](https://github.com/watchexec/cargo-watch) by [Félix Saparelli](https://github.com/passcod) : Utility to watch over your project's source for changes
- [cargo-checkmate](https://github.com/cargo-checkmatcargo-checkmate) by [Nathan Wilcox](https://github.com/nathan-at-least) : Perform a series of useful checks out of the box.
- [cargo-about](https://github.com/EmbarkStudiocargo-about) by [Jake Shadle](https://github.com/Jake-Shadle) : Cargo plugin for generating a license listing for all dependencies of a crate
- [cargo-hack](https://github.com/taiki-cargo-hack) by [Taiki Endo](https://github.com/taiki-e) : Cargo subcommand to provide various options useful for testing and continuous integration
...
- ( __image_ ) - reading / writing / manipulating various image formats
